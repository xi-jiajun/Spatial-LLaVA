...
# OMNI3D_DATA_FOLDER=./playground/data/eval/spatial_bench/omni3d/datasets/
OMNI3D_DATA_FOLDER=/PATH/TO/OMNI3D_DATA_FOLDER
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.eval_spatial \
        --model-path rogerxi/Spatial-LLaVA-7B \
...
output_file=./eval_output/$CKPT/spatial/v1/answers/space_merge.jsonl
